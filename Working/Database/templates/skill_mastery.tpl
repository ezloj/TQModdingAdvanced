	...
	Group
	{
		...
		Group
		{
			...
			Variable
			{
				...
				description = ""
				value = ""
				defaultValue = "MasterySpirit;MasteryNature;MasteryStealth;MasteryHunting;MasteryStorm;MasteryEarth;MasteryDefense;MasteryWarfare;MasteryDreams;MasteryBerserk;MasteryNeidan"
			}
